...
const Membership = () => {
  const [openIndex, setOpenIndex] = useState(null); // No question open initially

  const faqs = [
    {
      question: 'Lorem ipsum dolor sit amet consectetur adipiscing eliteiusmod tempor incididunt?',
      answer:
    ...
    {
      question: 'Excepteur sint occaecat cupidatat non proident, sunt in culpa qui official?',
      answer: 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sedqu non numquam eius modi tempora incidunt ut labore et dolore.',
    },
    {
    ...
    {
      question: 'Quis autem vel eum iure reprehenderit qui in ea voluptate velit essen?',
      answer: 'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sedqu non numquam eius modi tempora incidunt ut labore et dolore.',
    },
  ];
        ...
        <div className="space-y-2 ">
          {faqs.map((faq, index) => (
            <div key={index}>
              ...
              {/* Answer block, outside the border */}
