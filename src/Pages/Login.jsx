      ...
      <div>
        <div className="min-h-screen bg-[#121418] text-white px-6 py-10 flex flex-col lg:flex-row justify-center">
          <div className="w-full lg:w-2/4 lg:mr-12">
            <h2 className="text-2xl font-semibold mb-8">Login to Account</h2>
            ...
            <Link to="/Forget" className=" text-[#21A8F3] flex flex-col ml-113">
              Forget Password?
            </Link>
            <button className="mt-10 border-1 p-2  ml-107 bg-white text-black">
              {" "}
              Create an account{" "}
            </button>
          </div>
