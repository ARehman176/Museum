...
const Supportus = () => {
    const supportOptions = [
  {
    ...
    imageUrl: donate, // Replace with actual image
  },
  {
    title: "Donate Now",
    description:
      "Duis aute irure reprehenderit voluptate velit esse cillum euea fugiat sint occaecat cupidatatam.",
    imageUrl:donate1, // Replace with actual image
  },
  {
    title: "Submit Historical Content",
    description:
      "Duis aute irure reprehenderit voluptate velit esse cillum euea fugiat sint occaecat cupidatatam.",
    imageUrl: donate2, // Replace with actual image
  },
];
    ...
    <div className='bg-black'>
      ...
      <div className="md:w-2/4 mb-10 md:mb-0">
        <h2 className="text-2xl md:text-3xl font-bold mb-4">
          Your support is vital and helps the Museum<br />
          to share the collection with the world.
        </h2>
        <p className="text-[#929292] mb-6">
          The Museum relies on support from a wide range of sources and there are<br/> many ways
          that you can donate to help care for and preserve the collection<br/> for future generations.
          You can donate as an individual, or through a<br/> foundation, trust or company.
      ...
      <div className="md:w-1/3 flex flex-col justify-between">
        <div>
          ...
          <p className="text-[#CACACA] mb-2 mt-10">For more information about supporting <br/>the Museum:</p>
      ...
      <div className="grid md:grid-cols-3 gap-6 w-265 ml-38">
        {supportOptions.map((option, index) => (
          <div key={index} className="bg-[#23262D]  overflow-hidden ">
            <img src={option.imageUrl} alt={option.title} className="  w-full h-52 object-cover" />
            <div className="p-4">
